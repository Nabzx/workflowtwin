...
import type { Draft, Recommendation } from "../api/schemas";
  ...
  return (
    <div className="page-container pilot-page">
      ...
      <section className="pilot-workspace" aria-label="Pilot recommendations">
        ...
        <div className="recommendation-detail">{selected ? <RecommendationDetail recommendation={selected.recommendation} draft={selected.draft} /> : <p>Select a recommendation to inspect its evidence.</p>}</div>
      </section>
    </div>
  );
}
